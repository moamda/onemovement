...
/**
 * GroupSectorialSearch represents the model behind the search form about `app\models\GroupSectorial`.
 */
class GroupSectorialSearch extends GroupSectorial
{
    /**
     * @inheritdoc
     */
