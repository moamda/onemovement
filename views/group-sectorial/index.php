...
/* @var $searchModel app\models\GroupSectorialSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Sectorials';

CrudAsset::register($this);

?>
<div class="group-sectorial-index">
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['create'],
                        ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Group Sectorials', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
