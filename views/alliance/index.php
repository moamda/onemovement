...
/* @var $searchModel app\models\AllianceSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Alliances';

CrudAsset::register($this);

?>
<div class="alliance-index">
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['create'],
                        ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Alliances', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
